...
module Hibinium
  class Scenario
    ...
    # @param start_date
    # @param end_date
    def self.get_work_record_table(browser, start_date, end_date)
    ...
    # @param year
    # @param month
    def self.get_monthly_work_record_table(browser, year = "", month = "")
      ...
      get_work_record_table(browser, start_date, end_date)
    end
